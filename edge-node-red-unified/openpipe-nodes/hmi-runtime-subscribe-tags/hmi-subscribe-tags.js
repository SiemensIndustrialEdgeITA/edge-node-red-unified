...
module.exports = function(RED) {
    function HmiRuntimeReadTagsNode(config) {
        ...
        var subscribe_tags_object = {"Message":"SubscribeTag","Params":{"Tags":[]},"ClientCookie":"NodeRedCookieForSubscribeTags"};
        ...
        function RTconnectSocket(){
          ...
          //  TODO: put path into config of node
        ...
        function subscribeTags(){
          ...
          node.log('Subscribe for Tags: ' + tags)
          tags.forEach(function(tag){
            subscribe_tags_object.Params.Tags.push(tag);
          })

          // convert JSON object to string and add \n
          var subscribe_tags_cmd = JSON.stringify(subscribe_tags_object);
          subscribe_tags_cmd += '\n';

          // subscribe
          rt_socket_client.write(subscribe_tags_cmd);
        }
    ...
    RED.nodes.registerType("hmi-subscribe-tags",HmiRuntimeReadTagsNode);
}